...
/**
 * Factory for basket/product JSON API client
 *
 * @package Client
 * @subpackage JsonApi
 */
...
{
	/**
	 * Creates a basket/product client object.
	 *
	...
	public static function createClient( \Aimeos\MShop\Context\Item\Iface $context, array $templatePaths, $path, $name = null )
	{
		...
		{
			$classname = is_string( $name ) ? '\\Aimeos\\Client\\JsonApi\\Basket\\Product\\' . $name : '<not a string>';
		...
		$classname = '\\Aimeos\\Client\\JsonApi\\Basket\\Product\\' . $name;
