...
/**
 * Factory for customer/review JSON API client
 *
 * @package Client
 * @subpackage JsonApi
 */
...
{
	/**
	 * Creates a customer/review client object.
	 *
	 * @param \Aimeos\MShop\Context\Item\Iface $context Shop context instance with necessary objects
	 * @param string $path Name of the client separated by slashes, e.g "review"
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $path, string $name = null ) : \Aimeos\Client\JsonApi\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'client/jsonapi/customer/review/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\JsonApi\\Iface';
		$classname = '\\Aimeos\\Client\\JsonApi\\Customer\\Review\\' . $name;
