...
/**
 * Factory for catalog JSON API client
 *
 * @package Client
 * @subpackage JsonApi
 */
	...
	implements \Aimeos\Client\JsonApi\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\ContextIface $context, string $path, string $name = null ) : \Aimeos\Client\JsonApi\Iface
	{
		 ...
		 */
		if( $name === null ) {
			$name = $context->config()->get( 'client/jsonapi/catalog/name', 'Standard' );
		}
		 ...
		 * @see client/jsonapi/catalog/decorators/global
		 * @see client/jsonapi/catalog/decorators/local
		 */
		 ...
		 * @category Developer
		 * @see client/jsonapi/common/decorators/default
		 * @see client/jsonapi/catalog/decorators/excludes
		 * @see client/jsonapi/catalog/decorators/local
		 */
